      ...
      <AnimatePresence mode="wait">
        {!showOptions ? (
          <motion.div
            key="start"
            initial={
              initAnimation ? { opacity: 0, y: 20 } : { opacity: 1, y: 0 }
            }
          ...
          >
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
              <Button
                ...
                unstyled
                className="group relative px-16 py-5 text-2xl font-black tracking-wider overflow-hidden rounded-xl"
                style={{
                  background:
                    "linear-gradient(135deg, #FFE5B8 0%, #FFD88A 50%, #D4B887 100%)",
                  boxShadow:
                    "0 10px 40px rgba(255, 229, 184, 0.5), 0 0 20px rgba(255, 216, 138, 0.3)",
              ...
              >
                ...
                <span className="relative z-10 flex items-center gap-3 text-slate-900 group-hover:text-slate-800 transition-colors">
                  <motion.span
            ...
            <motion.p
              ...
              className="text-amber-200 text-sm tracking-[0.3em] font-light"
            >
          ...
          >
            ...
            >
              <button
                ...
                className="group relative px-12 py-4 text-lg font-bold tracking-wider overflow-hidden rounded-xl min-w-[280px]"
                style={{
                  background:
                    "linear-gradient(135deg, #A78BFA 0%, #8B7FDD 100%)",
            ...
            <motion.button
              ...
              className="mt-2 text-amber-300 text-sm hover:text-amber-200 transition-colors"
            >
              ← 돌아가기
            </motion.button>
          </motion.div>
